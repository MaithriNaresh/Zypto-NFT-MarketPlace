...
document.addEventListener("DOMContentLoaded", (event) => {
  ...
  const cardsWrappers = gsap.utils.toArray(".flow-card-wrapper");
...
function initMenu(){
  let navWrap = document.querySelector(".aside")
  ...
  let menuButtonTexts = menuButton.querySelectorAll("small")
