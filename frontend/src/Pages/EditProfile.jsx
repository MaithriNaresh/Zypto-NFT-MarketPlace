...
const EditProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (img) {
      formData.append("image", img); // only append if image selected
    }
    formData.append("name", uData.name);
    formData.append("email", uData.email);
    formData.append("password", uData.password);

    try {
      const response = await axios.put(
        `http://localhost:5656/updateuser/${id}`,
        formData,
        {
          headers: {
                ...
                <div className="d-flex flex-column">
                  <div className="flex mb-3">
                    ...
                    <input
                      ...
                      name="image" // MUST match key used in FormData and backend
                      required
                    />
                  ...
                  <button
                    className="btn btn-secondary rounded-pill text-center mt-4"
                    type="submit"
                  >
                    Continue
                  </button>
