...
const SingleNft = () => {
  ...
  const fetchSinglenft = async (id) => {
    try {
      const res = await axios.get(`http://localhost:5656/getAuctionsWithNft/${id}`);
    //   console.log("Auction response:", res.data);
      setSnft(res.data);
    } catch (err) {
      console.error("Failed to fetch NFT auction:", err.response?.data || err.message);
    }
  };
  ...
  const handleBidSubmit = async(auctionId) =>{
   ...
   const response = await axios.put(`http://localhost:5656/placeBid/${auctionId}`,{
    uid , bidamt:Number(bidAmount)
   }).then((res)=>{
                    ...
                    <div className="accordion">
                        ...
                        <div className="accordion-item">
                            <div className="accordion-header">
                                <button className="accordion-button d-flex align-items-center gap-2 h2 fw-bold mb-0 collapsed" type="button" aria-expanded="false">
                                    <svg width="18" height="18" viewBox="0 0 32 32">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M10 6H28V8H10V6ZM10 24H28V26H10V24ZM10 15H28V17H10V15ZM4 15H6V17H4V15ZM4 6H6V8H4V6ZM4 24H6V26H4V24Z" fill="currentColor"></path>
                                    </svg>
                                    Properties
                                </button>
                            </div>
                                    ...
                                    <div className="properties-grid gap-2">
                                        ...
                                        <div className="col text-center card-border redius p-2">
                                            ...
                                            <div className="text-sm grayscale-200 mb-0 mt-1">
                                                18% <span className="grayscale-500">have this trait</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col text-center card-border redius p-2">
                                            ...
                                            <div className="text-sm grayscale-200 mb-0 mt-1">
                                                29% <span className="grayscale-500">have this trait</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col text-center card-border redius p-2">
                                            ...
                                            <div className="text-sm grayscale-200 mb-0 mt-1">
                                                34% <span className="grayscale-500">have this trait</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col text-center card-border redius p-2">
                                            ...
                                            <div className="text-sm grayscale-200 mb-0 mt-1">
                                                26% <span className="grayscale-500">have this trait</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col text-center card-border redius p-2">
                                            ...
                                            <div className="text-sm grayscale-200 mb-0 mt-1">
                                                12% <span className="grayscale-500">have this trait</span>
                                            </div>
                                        </div>
                            ...
                            <div className="accordion-header">
                                <button className="accordion-button d-flex align-items-center gap-2 h2 fw-bold mb-0 collapsed" type="button" aria-expanded="false">
                                    <svg width="18" height="18" viewBox="0 0 20 20" fill="none">
                                        ...
                                        <path d="M11.6667 2.6665V6.6665H15.6667" stroke="currentColor" strokeWidth="1" strokeLinecap="square" strokeLinejoin="round"></path>
                                        <path d="M13.3334 10.8335H6.66675" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
                                        <path d="M13.3334 14.1665H6.66675" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
                                        <path d="M8.33341 7.5H7.50008H6.66675" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
                                    </svg>
                                    Description
                                </button>
                            </div>
                            <div className="accordion-collapse collapse">
                                <div className="accordion-body">
                                    <div className="d-flex align-items-center gap-3 py-1">
                                        ...
                                        {/* <!-- avater --> */}
                                        <a className="flex animation-2" href="collections.html">
                                            <img className="avater xl redius border-2x card-transform-x" alt="" src="images/user/Elementals.jpg"/>
                                        </a>
                                        ...
                                        <div className="flex">
                                            ...
                                            <div className="d-flex align-items-center gap-2 mb-2">
                                                ...
                                                {/* <!-- title --> */}
                                                <a className="d-flex align-items-center gap-2 fs-6 fw-bold grayscale-200 link-secondary mb-0" href="collections.html">
                                                    Azuki Elementals
                                                ...
                                                <span className="d-flex align-items-center gap-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Star collection to add it to your watchlist.">
                                                    <svg className="favme" width="14" height="14" viewBox="0 0 16 16" stroke="currentColor" fill="currentColor" strokeWidth="0.5">
                                            ...
                                            <div className="filter-wrapper align-items-center gap-1 mb-2">
                                                ...
                                                {/* <!-- chain --> */}
                                                <a className="d-inline-flex gap-2 text-bg-bs card-border redius px-2 py-1" href="#" role="button">
                                                    ...
                                                    <span className="meta text-xs grayscale-100 text-link mb-0">Ethereum</span>
                                                </a>

                                                {/* <!-- token --> */}
                                                <a className="d-inline-flex gap-2 text-bg-bs card-border redius px-2 py-1" href="#" role="button">
                                                    <span className="meta text-xs grayscale-100 text-link mb-0">ERC-721</span>
                                                </a>

                                                {/* <!-- categories --> */}
                                                <a className="d-inline-flex gap-2 text-bg-bs card-border redius px-2 py-1" href="#" role="button">
                                                    <span className="meta text-xs grayscale-100 text-link mb-0">PFPs</span>
                                                </a>
                        ...
                        <div className="accordion-item">
                            <div className="accordion-header">
                                <button className="accordion-button collapsed d-flex align-items-center gap-2 h2 fw-bold mb-0" type="button">
                                    <svg width="18" height="18" viewBox="0 0 32 32">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M4 26C4.0011 27.1041 4.89589 27.9989 6 28H26C27.1041 27.9989 27.9989 27.1041 28 26V6C27.9989 4.89589 27.1041 4.0011 26 4H6C4.89589 4.0011 4.0011 4.89589 4 6V26ZM6 26V6H26L26.001 26H6ZM17 22V13H13V15H15V22H12V24H20V22H17ZM14.5 9.83333C14.5 9.00491 15.1716 8.33333 16 8.33333C16.8284 8.33333 17.5 9.00491 17.5 9.83333C17.5 10.6618 16.8284 11.3333 16 11.3333C15.1716 11.3333 14.5 10.6618 14.5 9.83333Z" fill="currentColor"></path>
                                    </svg>
                                    Details
                                </button>
                            </div>
                                ...
                                <div className="accordion-body">
                                    <div className="d-grid gap-3">
                                        <div className="d-flex justify-content-between align-items-center">
                                            <span className="grayscale-400 mb-0">Contract Address</span>
                                            <a className="grayscale-100 fw-medium text-link mb-0" href="#">0xb6a3...786e</a>
                                        </div>
                                        <div className="d-flex justify-content-between align-items-center">
                                            <span className="grayscale-400 mb-0">Token ID</span>
                                            <a className="grayscale-100 fw-medium text-link" href="#">8924</a>
                                        </div>
                                        <div className="d-flex justify-content-between align-items-center">
                                            <span className="grayscale-400 mb-0">Token Standard</span>
                                            <span className="grayscale-100 fw-medium mb-0">ERC-721</span>
                                        </div>
                                        <div className="d-flex justify-content-between align-items-center">
                                            <span className="grayscale-400 mb-0">Chain</span>
                                            <span className="grayscale-100 fw-medium mb-0">Ethereum</span>
                                        </div>
                                        <div className="d-flex justify-content-between align-items-center">
                                            <span className="grayscale-400 mb-0">Creator Earnings</span>
            ...
            <div className="col-md-6">
                ...
                <div className="flex">
                    ...
                    <div className="d-flex justify-content-between align-items-center gap-2 px-0">
                            ...
                            <div className="nav-link" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <div className="bid-info">
                                    <div className="img-box redius border-2x">
                                        <img src={snft?.userData?.image} alt="" width="40"/>
                                    </div>
                                    <span className="h5 fw-bold text-link grayscale-300 mb-0">{snft?.nftData?.name}</span>
                                    <svg display="block" width="16" height="16" viewBox="0 0 12 12" fill="none">
                            ...
                            <div className="profile_menu dropdown-menu menu-xl dropdown-menu-shows redius">
                                <div className="nft-card card-bs p-2">
                                    ...
                                    <div className="d-flex gap-3 align-items-center mb-3">
                                        <div className="bid-info">
                                            <img className="redius border-2x" src={snft?.userData?.image} alt="" width="50"/>
                                        </div>
                                        <div className="d-grid">
                                            <div className="d-flex align-items-center gap-2">
                                                <a href="collection-single.html" className="h5 grayscale-100 text-link mb-0">{snft?.nftData?.name}</a>
                                                <svg display="block" width="20" height="20" viewBox="0 0 12 12" fill="none">
                                                    <path d="M4.78117 0.743103C5.29164 -0.247701 6.70826 -0.247701 7.21872 0.743103C7.52545 1.33846 8.21742 1.62509 8.8553 1.42099C9.91685 1.08134 10.9186 2.08304 10.5789 3.1446C10.3748 3.78247 10.6614 4.47445 11.2568 4.78117C12.2476 5.29164 12.2476 6.70826 11.2568 7.21872C10.6614 7.52545 10.3748 8.21742 10.5789 8.8553C10.9186 9.91685 9.91685 10.9186 8.8553 10.5789C8.21742 10.3748 7.52545 10.6614 7.21872 11.2568C6.70826 12.2476 5.29164 12.2476 4.78117 11.2568C4.47445 10.6614 3.78247 10.3748 3.1446 10.5789C2.08304 10.9186 1.08134 9.91685 1.42099 8.8553C1.62509 8.21742 1.33846 7.52545 0.743103 7.21872C-0.247701 6.70826 -0.247701 5.29164 0.743103 4.78117C1.33846 4.47445 1.62509 3.78247 1.42099 3.1446C1.08134 2.08304 2.08304 1.08134 3.1446 1.42099C3.78247 1.62509 4.47445 1.33846 4.78117 0.743103Z" fill="var(--brand-color)"></path>
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M8.43961 4.23998C8.64623 4.43922 8.65221 4.76823 8.45297 4.97484L5.40604 8.13462L3.54703 6.20676C3.34779 6.00014 3.35377 5.67113 3.56039 5.47189C3.76701 5.27266 4.09602 5.27864 4.29526 5.48525L5.40604 6.63718L7.70475 4.25334C7.90398 4.04672 8.23299 4.04074 8.43961 4.23998Z" fill="rgb(25, 28, 31)"></path>
                                                </svg>
                                            </div>
                                            <div className="d-flex align-items-center gap-2">
                                                <h6 className="grayscale-400 mb-0">Created by</h6>
                                                <a className="fw-bold grayscale-100 text-link mb-0" href="user-single.html">@{snft?.userData?.name}</a>
                                            </div>
                                        </div>
                                    </div>
                                    {/* <!-- data --> */}
                                    <div className="filter-wrapper justify-content-between card-bs card-border p-2 text-sm mb-2">
                                        <div className="d-grid gap-1">
                                            <span className="h6 fw-medium grayscale-500">Floor</span>
                                            <span className="h5 fw-bold grayscale-100">3.06 ETH</span>
                                        </div>
                                        <div className="d-grid gap-1">
                                            <span className="h6 fw-medium grayscale-500">Volume</span>
                                            <span className="h5 fw-bold grayscale-100">96.2K ETH</span>
                                        </div>
                                        <div className="d-grid gap-1">
                                            <span className="h6 fw-medium grayscale-500">Items</span>
                                            <span className="h5 fw-bold grayscale-100">10K</span>
                                        </div>
                                    </div>
                                    {/* <!-- nft --> */}
                                    <div className="crypt-scroll mt-2" data-scroll="" data-scroll-speed="3">
                                        <div className="crypt-scrolling">
                                            {/* <!-- nft 1 --> */}
                                            <div className="gsap-image">
                                                <img src="images/nft/azuki-1.jpg" alt="" width="120"/>
                                            </div>
                                            {/* <!-- nft 2 --> */}
                                            <div className="gsap-image">
                                                <img src="images/nft/azuki-10.jpg" alt="" width="120"/>
                                            </div>
                                            {/* <!-- nft 3 --> */}
                                            <div className="gsap-image">
                                                <img src="images/nft/azuki-2.jpg" alt="" width="120"/>
                                            </div>
                                            {/* <!-- nft 4 --> */}
                                            <div className="gsap-image">
                                                <img src="images/nft/azuki-3.jpg" alt="" width="120"/>
                                            </div>
                                            {/* <!-- nft 5 --> */}
                                            <div className="gsap-image">
                                                <img src="images/nft/azuki-4.jpg" alt="" width="120"/>
                                            </div>
                                            {/* <!-- nft 6 --> */}
                                            <div className="gsap-image">
                                                <img src="images/nft/azuki-5.jpg" alt="" width="120"/>
                                            </div>
                                            {/* <!-- nft 7 --> */}
                                            <div className="gsap-image">
                                                <img src="images/nft/azuki-6.jpg" alt="" width="120"/>
                                            </div>
                                            {/* <!-- nft 8 --> */}
                                            <div className="gsap-image">
                                                <img src="images/nft/azuki-7.jpg" alt="" width="120"/>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="d-flex gap-2">
                            ...
                            <button className="btn btn-editor btn-dark px-2 d-flex align-items-center grayscale-200 gap-2">
                                <span data-toast="fav-toast" className="toast-btn grayscale-400" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add to favorites">
                                    <svg className="favme" width="18" height="18" fill="currentColor" viewBox="0 0 1024 1024">
                            ...
                            <div className="dropdown z-2">
                                <a className="btn btn-editor btn-dark px-2" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                            ...
                            <div className="dropdown z-2">
                                {/* <!-- icon --> */}
                                <a className="btn btn-editor btn-dark px-2" href="#!" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div className="profile_menu">
                                    <div className="dropdown-menu redius card-bs card-border p-2">
                                        ...
                                        {/* <!-- link --> */}
                                        <a className="dropdown-item card-bs d-flex align-items-center fw-medium gap-2" href="#">
                                        ...
                                        {/* <!-- link --> */}
                                        <a data-toast="refresh-toast" className="toast-btn dropdown-item card-bs d-flex align-items-center fw-medium gap-2" href="#!">
                                            <svg width="16" height="16" viewBox="0 0 18 18" fill="none">
                                                <path d="M2.25 9C2.25 7.20979 2.96116 5.4929 4.22703 4.22703C5.4929 2.96116 7.20979 2.25 9 2.25C10.887 2.2571 12.6983 2.99342 14.055 4.305L15.75 6" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"></path>
                                                <path d="M15.75 2.25V6H12" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"></path>
                                                <path d="M15.75 9C15.75 10.7902 15.0388 12.5071 13.773 13.773C12.5071 15.0388 10.7902 15.75 9 15.75C7.11296 15.7429 5.30173 15.0066 3.945 13.695L2.25 12" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"></path>
                                                <path d="M6 12H2.25V15.75" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"></path>
                                            </svg>
                                            Refresh Metadata
                                        </a>
                    ...
                    <div className="flex mt-2">
                        <div data-tabs-fade="" className="h3 grayscale-100 mb-4">Elementals #446</div>
                    </div>
                    ...
                    <div className="d-flex align-items-center gap-2 px-0 mb-4">
                        ...
                        <div className="dropdown nav-item profile_menu">
                            ...
                            {/* <!-- nav link --> */}
                            <div className="bid-info btn btn-editor btn-dark px-1 py-1" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div className="nft-card card-bs p-2">
                                    ...
                                    <div className="d-flex justify-content-between mb-3">
                                        ...
                                        <div className="d-flex gap-3">
                                            <div className="bid-info">
                                                <img className="circle border-2x" src="images/user/XCOPY.gif" alt="" width="50"/>
                                            </div>
                                            <div className="d-grid">
                                                <div className="h4 product-name mb-1">
                                                    <div className="d-flex align-items-center gap-2">
                                                        <a className="heading-5 grayscale-200 text-link mb-0" href="">
                                                            0X9999E
                                                        </a>
                                                        <svg display="block" width="16" height="16" viewBox="0 0 12 12" fill="none">
                                                            <path d="M4.78117 0.743103C5.29164 -0.247701 6.70826 -0.247701 7.21872 0.743103C7.52545 1.33846 8.21742 1.62509 8.8553 1.42099C9.91685 1.08134 10.9186 2.08304 10.5789 3.1446C10.3748 3.78247 10.6614 4.47445 11.2568 4.78117C12.2476 5.29164 12.2476 6.70826 11.2568 7.21872C10.6614 7.52545 10.3748 8.21742 10.5789 8.8553C10.9186 9.91685 9.91685 10.9186 8.8553 10.5789C8.21742 10.3748 7.52545 10.6614 7.21872 11.2568C6.70826 12.2476 5.29164 12.2476 4.78117 11.2568C4.47445 10.6614 3.78247 10.3748 3.1446 10.5789C2.08304 10.9186 1.08134 9.91685 1.42099 8.8553C1.62509 8.21742 1.33846 7.52545 0.743103 7.21872C-0.247701 6.70826 -0.247701 5.29164 0.743103 4.78117C1.33846 4.47445 1.62509 3.78247 1.42099 3.1446C1.08134 2.08304 2.08304 1.08134 3.1446 1.42099C3.78247 1.62509 4.47445 1.33846 4.78117 0.743103Z" fill="var(--brand-color)"></path>
                                                ...
                                                <div className="d-flex justify-content-between align-items-center gap-2" role="button">
                                                    {/* <!-- address --> */}
                                                    <span className="meta text-xs grayscale-400 link-secondary mb-0" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Copy address">
                                                        0x6e75r...c5464
                                                    </span>
                                        ...
                                        {/* <!-- cta --> */}
                                        <div className="flex">
                                            <a className="btn btn-dark btn-editor-sm meta text-xs grayscale-400 text-link d-flex align-items-center gap-2 mb-0 py-1" role="button" href="#!">
                                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                    <path d="M3.75 9H14.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                                    <path d="M9 3.75V14.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                                </svg>
                                                Follow
                                            </a>
                                        </div>
                                    ...
                                    <div className="crypt-scroll mt-2" data-scroll="" data-scroll-speed="3">
                                        <div className="crypt-scrolling">
                                            ...
                                            <div className="circle redius">
                                                <img src="images/nft/azuki-3.jpg" alt="" width="80"/>
                                            </div>
                                            {/* <!-- nft 2 --> */}
                                            <div className="circle redius">
                                                <img src="images/nft/azuki-7.jpg" alt="" width="80"/>
                                            </div>
                                            {/* <!-- nft 3 --> */}
                                            <div className="circle redius">
                                                <img src="images/nft/HypioBabies-1.jpg" alt="" width="80"/>
                                            </div>
                                            {/* <!-- nft 4 --> */}
                                            <div className="circle redius">
                                                <img src="images/nft/Valhalla-2.jpg" alt="" width="80"/>
                                            </div>
                                            {/* <!-- nft 5 --> */}
                                            <div className="circle redius">
                                                <img src="images/nft/azuki-7.jpg" alt="" width="80"/>
                                            ...
                                            {/* <!-- nft 6 --> */}
                                            <div className="circle redius">
                                                <img src="images/nft/azuki-1.jpg" alt="" width="80"/>
                                            </div>
                                            {/* <!-- nft 7 --> */}
                                            <div className="circle redius">
                                                <img src="images/nft/HypioBabies-2.jpg" alt="" width="80"/>
                                            </div>
                                            {/* <!-- nft 8 --> */}
                                            <div className="circle redius">
                                                <img src="images/nft/Valhalla-3.jpg" alt="" width="80"/>
                                            </div>
                        ...
                        <span className="d-flex align-items-center meta text-xs gap-1 text-bg-bs card-border redius px-2 py-1">
                            Owned by
                            <a className="d-flex align-items-center gap-1 mt-1 mt-sm-0" href="user-single.html">
                                <img className="circle card-border" src="images/user/ava_2.png" alt="" width="16"/>
      ...
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
        ...
        >
          <circle
            ...
            strokeWidth="1.5"
          />
          <circle cx="17" cy="7" r="1" fill="var(--color-primary-100)" />
        </g>
      </svg>
      ...
      />
                        ...
                        <div className="flex p-3 mb-3">
                            ...
                            <div className="d-flex align-items-end gap-2 h2 grayscale-100 mb-0">
                                0.324
                                <span className="meta fs-4 fw-medium grayscale-400 mb-0">ETH</span>
                            </div>
                            <div className="grayscale-500 fs-6 mt-2">≈ ${snft?.nftData?.saleprice}</div>
                        </div>
...
>
                                    ...
                                    {new Date() < new Date(snft.startDate) && (
  <small className="text-warning">Auction not started yet</small>
)}

{new Date() > new Date(snft.endDate) && (
  <small className="text-danger">Auction has ended</small>
)}
    ...
    <div className="modal-dialog">
      <div className="modal-content">
        ...
        <div className="modal-footer">
          <button className="btn btn-secondary" onClick={() => setShowBidmodel(false)}>Cancel</button>
          <button className="btn btn-primary" onClick={() => {handleBidSubmit(snft._id)}}>Submit Bid</button>
        </div>
      </div>
    </div>
  </div>
                            ...
                            <div className="col-auto ml-auto">
                                <div className="d-grid">
                                    <button className="btn btn-dark border-0 py-2 px-4" type="button">
                                        Make offer
                                    </button>
                                </div>
                            </div>
                ...
                <div className="flex mt-4">
                    <div className="accordion">
                        ...
                        <div className="accordion-item">
                            {/* <!-- title --> */}
                            <div className="accordion-header">
                                <button className="accordion-button collapsed gap-2 fs-5 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#History" aria-expanded="true" aria-controls="History">
                            ...
                            {/* <!-- chart --> */}
                            <div id="History" className="accordion-collapse collapse show" aria-labelledby="History">
                                <div className="accordion-body px-3 pb-2 pt-0">

                                    <div className="col-md-8 h6 grayscale-400 py-1">
                                        To switch directories, type <kbd>cd</kbd> followed by the directory.
                                        The fastest way to the Clear browsing data, press <kbd><kbd>Ctrl</kbd> + <kbd>Shift</kbd></kbd> r
                                    </div>
                        ...
                        <div className="accordion-item">
                            ...
                            <div className="accordion-header">
                                <button className="accordion-button gap-2 collapsed fs-5 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#Activity" aria-expanded="false" aria-controls="Activity">
                                    <svg width="24" height="24" viewBox="0 0 20 20" fill="none">
                                        <path d="M15.8333 2.5H4.16667C3.24619 2.5 2.5 3.24619 2.5 4.16667V15.8333C2.5 16.7538 3.24619 17.5 4.16667 17.5H15.8333C16.7538 17.5 17.5 16.7538 17.5 15.8333V4.16667C17.5 3.24619 16.7538 2.5 15.8333 2.5Z" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
                                        <path d="M14.1668 10.0002H12.5002L10.8335 14.1668L9.16683 5.8335L7.50016 10.0002H5.8335" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
                                    Activity
                                </button>
                            </div>
                                        ...
                                        <table className="table table-dark table-hover mb-0">
                                            <thead>
                                                <tr className="table-active mb-0">
                                                    <th scope="col" className="h6">Name</th>
                                                    <th scope="col" className="h6">Event</th>
                                                    <th scope="col" className="h6">Price</th>
                                                    <th scope="col" className="h6">Date</th>
                                            ...
                                            <tbody>
                                                <tr className="align-middle">
                                                    <td>
                                                        <div className="d-flex flex-row align-items-center gap-2">
                                                            <img alt="" src="images/user/ava_1.png" width="24"/>
                                                            <p className="d-flex align-items-center gap-2 fw-bold fs-6 mb-0">
                                                                ...
                                                                <span className="h6 grayscale-600 mb-0">Purchased for</span>
                                                            </p>
                                                        </div>
                                                    </td>
                                                    <td className="fw-medium">
                                                        <span className="badge text-bg-primary text-uppercase">Sale</span>
                                                    </td>
                                                    <td className="grayscale-300 fw-medium">6.95 ETH</td>
                                                    <td className="grayscale-500 fw-medium">1 day ago</td>
                                                    <td>
                                                        <a className="link-secondary fw-bold btn-tr" href="price.html" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Details">
                                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                                <path d="M7.50008 18.3333H12.5001C16.6667 18.3333 18.3334 16.6667 18.3334 12.5V7.49999C18.3334 3.33332 16.6667 1.66666 12.5001 1.66666L7.50008 1.66666C3.33341 1.66666 1.66675 3.33332 1.66675 7.49999L1.66675 12.5C1.66675 16.6667 3.33341 18.3333 7.50008 18.3333Z" stroke="var(--color-primary-500)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                                                <path d="M8.82495 6.39999H12.3583V9.94166" stroke="var(--color-primary-500)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                                                <path d="M12.3583 6.39999L7.6416 11.1167" stroke="var(--color-primary-500)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                                                <path d="M5 13.7583C8.24167 14.8417 11.7583 14.8417 15 13.7583" stroke="var(--color-primary-500)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                                            </svg>
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr className="align-middle">
                                                    <td>
                                                        <div className="d-flex flex-row align-items-center gap-2">
                                                            <img alt="" src="images/user/ava_3.png" width="24"/>
                                                            <p className="d-flex align-items-center gap-2 fw-bold fs-6 mb-0">
                                                                0x9870 ...RG34
                                                                <span className="h6 grayscale-600 mb-0">Unlisted for</span>
                                                            </p>
                                                        </div>
                                                    </td>
                                                    <td className="fw-medium">
                                                        <span className="badge text-bg-danger text-uppercase">Unlisted</span>
                                                    </td>
                                                    <td className="grayscale-600 fw-medium">--</td>
                                                    <td className="grayscale-500 fw-medium">2 day ago</td>
                                                    <td>
                                                        <a className="link-secondary fw-bold btn-tr" href="price.html" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Details">
                                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                                <path d="M7.50008 18.3333H12.5001C16.6667 18.3333 18.3334 16.6667 18.3334 12.5V7.49999C18.3334 3.33332 16.6667 1.66666 12.5001 1.66666L7.50008 1.66666C3.33341 1.66666 1.66675 3.33332 1.66675 7.49999L1.66675 12.5C1.66675 16.6667 3.33341 18.3333 7.50008 18.3333Z" stroke="var(--color-primary-500)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                                ...
                                                <tr className="align-middle">
                                                    <td>
                                                        <div className="d-flex flex-row align-items-center gap-2">
                                                            <img alt="" src="images/user/ava_6.png" width="24"/>
                                                            <p className="d-flex align-items-center gap-2 fw-bold fs-6 mb-0">
                                                                Forexus
                                                                <svg display="block" width="16" height="16" viewBox="0 0 12 12" fill="none">
                                                                    <path d="M4.78117 0.743103C5.29164 -0.247701 6.70826 -0.247701 7.21872 0.743103C7.52545 1.33846 8.21742 1.62509 8.8553 1.42099C9.91685 1.08134 10.9186 2.08304 10.5789 3.1446C10.3748 3.78247 10.6614 4.47445 11.2568 4.78117C12.2476 5.29164 12.2476 6.70826 11.2568 7.21872C10.6614 7.52545 10.3748 8.21742 10.5789 8.8553C10.9186 9.91685 9.91685 10.9186 8.8553 10.5789C8.21742 10.3748 7.52545 10.6614 7.21872 11.2568C6.70826 12.2476 5.29164 12.2476 4.78117 11.2568C4.47445 10.6614 3.78247 10.3748 3.1446 10.5789C2.08304 10.9186 1.08134 9.91685 1.42099 8.8553C1.62509 8.21742 1.33846 7.52545 0.743103 7.21872C-0.247701 6.70826 -0.247701 5.29164 0.743103 4.78117C1.33846 4.47445 1.62509 3.78247 1.42099 3.1446C1.08134 2.08304 2.08304 1.08134 3.1446 1.42099C3.78247 1.62509 4.47445 1.33846 4.78117 0.743103Z" fill="var(--brand-color)"></path>
                                                                ...
                                                                <span className="h6 grayscale-600 mb-0">Listed for</span>
                                                            </p>
                                                        </div>
                                                    </td>
                                                    <td className="fw-medium">
                                                        <span className="badge text-bg-success text-uppercase">Minted</span>
                                                    </td>
                                                    <td className="grayscale-300 fw-medium">6.95 ETH</td>
                                                    <td className="grayscale-500 fw-medium">1 day ago</td>
                                                    <td>
                                                ...
                                                <tr className="align-middle">
                                                    ...
                                                    <td className="fw-medium">
                                                        <span className="badge text-bg-secondary text-uppercase">Listed</span>
                                                    </td>
                                                    <td className="grayscale-600 fw-medium">--</td>
                                                    <td className="grayscale-500 fw-medium">1 day ago</td>
                                                    <td>
