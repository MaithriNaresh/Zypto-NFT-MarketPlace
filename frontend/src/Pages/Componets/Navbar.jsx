...
import profileImage from "/images/user/0X9999E.webp";
          ...
          <div className="header-boxed md-escape">
            <div className="d-flex flex-row transparent-menu-bg justify-content-between align-items-center redius border-0">
              ...
              <div className="d-flex gap-4">
                <button className="btn btn-editor btn-primary redius border-0 text-dark d-inline-flex align-items-center pe-3 ps-2" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                ...
                {/* <div className=" nav-item profile_menu"></div> */}
                 <div className="profile_menu d-flex align-items-center">
                                <div className="dropdown">

                                  
                                    <button className="btn btn-secondary dropdown-toggle no-active card-border d-flex align-items-center" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                    ...
                                    <div className="dropdown-menu redius card-bs card-border">
                                        ...
                                        <div className="d-flex gap-2 align-items-center card-bs-tabs redius mx-2 p-1">
                                            ...
                                            <img className="redius" alt="" src="images/user/XCOPY.gif" width="54"/>
                                            ...
                                            <div className="d-grid">
                                                ...
                                                <div className="d-flex justify-content-between align-items-center gap-1 text-bg-bs card-border redius ps-2" role="button">
                                        ...
                                        <div className="mt-2">
                                            <Link to = "/profile" className="dropdown-item d-flex align-items-center flex-row gap-2" href="profile.html">
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                                                    ...
                                                    <path d="M18.44 21.66C17.78 21.89 17.02 22 16.19 22H7.81C6.98 22 6.22 21.89 5.56 21.66C5.91 19.02 8.67 16.97 12 16.97C15.33 16.97 18.09 19.02 18.44 21.66Z" fill="currentColor"/>
                                                    <path d="M15.58 11.58C15.58 13.56 13.98 15.17 12 15.17C10.02 15.17 8.41998 13.56 8.41998 11.58C8.41998 9.60002 10.02 8 12 8C13.98 8 15.58 9.60002 15.58 11.58Z" fill="currentColor"/>
                                                </svg>
                                                Profile
                                            </Link>
                                            <a className="dropdown-item d-flex align-items-center gap-2" href="discover.html">
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                                                    <path opacity="0.4" d="M20.9799 3.01986C20.1099 2.14986 18.8799 1.80986 17.6899 2.10986L7.88986 4.55986C6.23986 4.96986 4.96986 6.24986 4.55986 7.88986L2.10986 17.6999C1.80986 18.8899 2.14986 20.1199 3.01986 20.9899C3.67986 21.6399 4.54986 21.9999 5.44986 21.9999C5.72986 21.9999 6.01986 21.9699 6.29986 21.8899L16.1099 19.4399C17.7499 19.0299 19.0299 17.7599 19.4399 16.1099L21.8899 6.29986C22.1899 5.10986 21.8499 3.87986 20.9799 3.01986Z" fill="currentColor"></path>
                                                    <path d="M12.0001 15.8801C14.143 15.8801 15.8801 14.143 15.8801 12.0001C15.8801 9.85725 14.143 8.12012 12.0001 8.12012C9.85725 8.12012 8.12012 9.85725 8.12012 12.0001C8.12012 14.143 9.85725 15.8801 12.0001 15.8801Z" fill="currentColor"></path>
                                                </svg>
                                                Discover
                                            </a>
                                            <a className="dropdown-item d-flex align-items-center gap-2" href="marketplace.html">
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <a className="dropdown-item d-flex align-items-center gap-2" href="my-nfts.html"> 
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <a style={{cursor:"pointer"}} className="dropdown-item d-flex align-items-center gap-2"
